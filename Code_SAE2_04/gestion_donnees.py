...
# Instance de la classe RecupDonnees
recup = RecupDonnees()
...
liste_valeurs_ouvrage1, liste_valeurs_ouvrage2 = RecupDonnees.diviser_liste(recup.liste_valeurs_ouvrage(liste_colonnes_ouvrage))
...
thread1 = threading.Thread(target=recup.creation, args=(nom_departement, liste_colonnes_departement, liste_type_colonnes_departement, recup.liste_valeurs_departement()))
thread1.start()
...
thread2 = threading.Thread(target=recup.creation, args=(nom_ouvrage, liste_colonnes_ouvrage, liste_type_colonnes_ouvrage, liste_valeurs_ouvrage1))
thread3 = threading.Thread(target=recup.creation, args=(nom_ouvrage, liste_colonnes_ouvrage, liste_type_colonnes_ouvrage, liste_valeurs_ouvrage2))
thread2.start()
thread3.start()
thread2.join()
thread3.join()
...
thread4 = threading.Thread(target=recup.creation, args=(nom_commune, liste_colonnes_commune, liste_type_colonnes_commune, recup.liste_valeurs_commune()))
thread4.start()
thread4.join()

# Thread 5 : insère les points de prélèvement (dépend des ouvrages et des départements)
thread5 = threading.Thread(target=recup.creation, args=(nom_pt_prelevement, liste_colonnes_pt_prelevement, liste_type_colonnes_pt_prelevement, recup.liste_valeurs_pt_prelevement(liste_colonnes_pt_prelevement)))
thread5.start()
thread5.join()